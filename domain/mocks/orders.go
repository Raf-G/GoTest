...
// AddOrder mocks base method.
func (m *MockOrdersService) AddOrder(arg0 int) (domain.Order, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddOrder", arg0)
	ret0, _ := ret[0].(domain.Order)
	ret1, _ := ret[1].(error)
...
// AddOrder indicates an expected call of AddOrder.
func (mr *MockOrdersServiceMockRecorder) AddOrder(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddOrder", reflect.TypeOf((*MockOrdersService)(nil).AddOrder), arg0)
}

// DeleteOrder mocks base method.
func (m *MockOrdersService) DeleteOrder(arg0 int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteOrder", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// DeleteOrder indicates an expected call of DeleteOrder.
func (mr *MockOrdersServiceMockRecorder) DeleteOrder(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteOrder", reflect.TypeOf((*MockOrdersService)(nil).DeleteOrder), arg0)
}

// GetOrder mocks base method.
func (m *MockOrdersService) GetOrder(arg0 int) (domain.Order, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOrder", arg0)
	ret0, _ := ret[0].(domain.Order)
	ret1, _ := ret[1].(error)
...
// GetOrder indicates an expected call of GetOrder.
func (mr *MockOrdersServiceMockRecorder) GetOrder(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOrder", reflect.TypeOf((*MockOrdersService)(nil).GetOrder), arg0)
}

// GetOrders mocks base method.
func (m *MockOrdersService) GetOrders() ([]domain.Order, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOrders")
	ret0, _ := ret[0].([]domain.Order)
	ret1, _ := ret[1].(error)
...
// GetOrders indicates an expected call of GetOrders.
func (mr *MockOrdersServiceMockRecorder) GetOrders() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOrders", reflect.TypeOf((*MockOrdersService)(nil).GetOrders))
}
